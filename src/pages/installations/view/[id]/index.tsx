...
import { useInstallationFindFirst, useRoqClient } from 'lib/roq';

import { InstallationInterface } from 'interfaces/installation';

function InstallationViewPage() {
  ...
  const { data, error, isLoading } = useInstallationFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('installation', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/installations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem
                  ...
                  text={data?.installation_date ? format(data?.installation_date, 'dd-MM-yyyy') : ''}
                />
