...
export function ProjectListPage(props: ProjectListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'installation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('installation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'installation',
          header: 'Installation',
          accessorKey: 'installation',
          cell: ({ row: { original: record } }: any) => record?._count?.installation,
        }
      : null,
