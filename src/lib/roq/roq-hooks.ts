...
export function useInstallationFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useInstallationFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.installation.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInstallationCount<T extends Prisma.installationCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.installationCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useInstallationCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.installation.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInstallationFindManyWithCount<
  T extends Prisma.installationFindManyArgs,
  R extends { data: GetFindResult<Prisma.$installationPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.installationFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useInstallationFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.installation.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useInstallationFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useInstallationFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.installation.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
